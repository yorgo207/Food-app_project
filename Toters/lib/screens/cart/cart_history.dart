...
import 'package:toters/base/no_data_page.dart';
      ...
      body: Column(
        children:[
          Container(
            ...
            padding: EdgeInsets.only(top:Dimensions.height15*3, bottom:Dimensions.width20),
            child: Row(
              ...
              children: [
                ...
                GestureDetector(
                  onTap:(){
                    Get.toNamed(RouteHelper.getCartPage(-1, "history"));
                  },
                  child:AppIcon(icon: Icons.shopping_cart_outlined, iconColor: AppColors.mainColor, backgroundColor: AppColors.yellowColor,),
          ...
          GetBuilder<CartController>(builder: (_cartController){
                    ...
                    child: ListView(
                      children:[
                        for(int i=0; i<itemsPerOrder.length;i++)
                          Container(
                              height: Dimensions.height10*12.5,
                                            ...
                                            children: [
                                              ...
                                              GestureDetector(
                                                onTap: (){
                                                  ...
                                                  Get.toNamed(RouteHelper.getCartPage(-1, "cartHistory"));
                                                },
                                                child: Container(
                                                  padding: EdgeInsets.symmetric(horizontal: Dimensions.width15/3,
            ...
            Container(
                ...
                child: Center( child:NoDataPage(text: "No Cart History",
